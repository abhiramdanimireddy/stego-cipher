...
Upload a PNG image
Set a password — mix letters, numbers, and symbols
Type your secret message
Click Hide Message and download the image
To reveal — upload the image, enter the same password, click Reveal
